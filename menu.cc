...
int main()
{
    ...
    while(true){
        ...
        if (opc == 2)
        {
            ...
            Usuario usuario = Usuario("12345678X", "Juan", "x", "0", 0);
            Organizador organizador = Organizador("98765432A", "Jose", "x", "1", 1);
            Director director = Director("11223344H", "Rafael", "x", "2", 2);
            ...
            while (true){
                ...
                if (director.GetCorreo() == correo && director.GetContrasena() == contrasena)
                {
                    while (o != 4)
                    {
                        ...
                        std::cout << "4. Cerrar sesión.r" << std::endl;
