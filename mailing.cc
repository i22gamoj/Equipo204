...
void Mailing::CrearCorreo(){
    ...
    std::cout<<"Escriba quién o quienes van a ser los destinatarios: ";//SE TIENEN QUE ESCRIBIR TODOS SEGUIDOS
    std::cin>> destinatario;
    std::cout<<"Escribe el concepto del mensaje: ";//SE TIENE QUE ESCRIBIR TODO SEGUIDO
    std::cin>>concepto;
    std::cout<<"Escribe el cuerpo del mensaje:"<<std::endl;//SE TIENE QUE ESCRIBIR TODO JUNTO
    std::cin>> cuerpo;
